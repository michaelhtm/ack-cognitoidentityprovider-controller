...
SERVICE_NAME = "cognitoidentityprovider"
CRD_GROUP = "cognitoidentityprovider.services.k8s.aws"
...
def load_cognitoidentityprovider_resource(resource_name: str, additional_replacements: Dict[str, Any] = {}):
