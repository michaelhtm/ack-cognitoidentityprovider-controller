...
const (
	FinalizerString = "finalizers.cognitoidentityprovider.services.k8s.aws/UserPool"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("userpools")
